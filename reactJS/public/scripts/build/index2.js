    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "td",
                null,
                React.createElement(OrderProductButton, { onOrderButtonClick: this.onProductButtonClickHandler, productName: this.props.product.name })
            )
        );
    }
});
...
var OrderProductButton = React.createClass({
    ...
    render: function () {
        return React.createElement(
            "button",
            { onClick: this.onButtonClickAction, id: this.props.productName },
            "Click me!"
        );
    }
});
